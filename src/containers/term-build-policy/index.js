...
class TermBuildPolicy extends React.Component {
  constructor(props) {
    super(props);
  ...
  onReviewSubmit(orderDetails, payload) {
    ...
    this.props.SetReviewDetails(primaryUserId, orderDetails, payload);
  }
  ...
  render() {
    ...
    return (
      <Stepper
        product={product}
        baseUrl="/term-life-insurance/build-policy"
      ...
      >
        ...
        />
        <Route
          path="/term-life-insurance/build-policy/coverage"
          render={props => (
            <BuildPolicyCoverage
              navigateTo={this.navigateTo}
              nextStep="/term-life-insurance/build-policy/info"
            />
          )}
        />
        <Route
          path="/term-life-insurance/build-policy/info"
          render={props => (
            <PersonalInfo
        ...
        />
        <Route
          path="/term-life-insurance/build-policy/quote"
          render={props => (
            <BuildPolicyQuote navigateTo={this.navigateTo} product={'term'} />
          )}
        />
        <Route
          path="/term-life-insurance/build-policy/review"
          render={props => (
            <Review
              navigateTo={this.navigateTo}
...
export default connect(mapsStateToProps, mapDispatchToProps)(TermBuildPolicy);
