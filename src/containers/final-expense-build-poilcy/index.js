...
class FinalExpenseBuildPolicy extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Stepper
        product={product}
        baseUrl="/final-expense-insurance/build-policy"
      ...
      >
        ...
        />
        <Route
          path="/final-expense-insurance/build-policy/info"
          render={props => (
            <PersonalInfo
              SetStep={this.props.SetStep}
              navigateTo={this.navigateTo}
        ...
        />
        <Route
          path="/final-expense-insurance/build-policy/quote"
          render={props => (
            <BuildPolicyQuote navigateTo={this.navigateTo} product={product} />
          )}
        />
        <Route
          path="/final-expense-insurance/build-policy/review"
          render={props => (
            <Review
              navigateTo={this.navigateTo}
